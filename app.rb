...
# new_list.add('todo', 'Hack some portals', priority: 'super high') # throws an
# InvalidPriorityValue error
...
# DEMO NEW FEATURE #2: Interactivity mode!
# Prompts the user for input to handle most UdaciList tasks
UdaciList.ui_mode
